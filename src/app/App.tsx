...
import { startAlarm as ringAlarm, getDefaultAlarmSound, snoozeAlarm, dismissAlarm } from '../lib/alarm';
...
export function App() {
  ...
  useEffect(() => {
    ...
    const off = onWorkerMessage({
      ...
      // Dismiss tapped on the push notification — off on every device.
      dismiss: (m) => { if (m?.key) dismissAlarm(m.key); },
